package com.cuiweiyou.knockofflongyuan.view;
...
public class ScrollUpdateListView extends ListView {
	...
	public boolean onTouchEvent(MotionEvent ev) {
		// 如果数据正在加载中，NullPointerException: Attempt to invoke interface method 'int android.widget.ListAdapter.getCount()' on a null object reference
		if(getAdapter() == null){
			...
			case MotionEvent.ACTION_UP: // 手指抬起
				...
				if(indexTopItem == 0){
					if (distanceUPY > measuredHeaderHeight * 2.5) {	// 达到一定距离，对footer中的子控件进行操作
						...
						//return true;	// 防止松开手指，点击进入了item祥页
					}
				...
				if(Math.abs(distanceUPY) > touchSlop){
					Log.e("sst", "true");
					return true;
				}
	...
	private void initAnimHeader() {
		Drawable d1 = getContext().getResources().getDrawable(R.drawable.load01);
		Drawable d2 = getContext().getResources().getDrawable(R.drawable.load02);
		Drawable d3 = getContext().getResources().getDrawable(R.drawable.load03);
		Drawable d4 = getContext().getResources().getDrawable(R.drawable.load04);
		Drawable d5 = getContext().getResources().getDrawable(R.drawable.load05);
		Drawable d6 = getContext().getResources().getDrawable(R.drawable.load06);
		Drawable d7 = getContext().getResources().getDrawable(R.drawable.load07);
		Drawable d8 = getContext().getResources().getDrawable(R.drawable.load08);
	...
	private void initAnimFooter() {
		Drawable a1 = getContext().getResources().getDrawable(R.drawable.longmao01);
		Drawable a2 = getContext().getResources().getDrawable(R.drawable.longmao02);
		Drawable a3 = getContext().getResources().getDrawable(R.drawable.longmao03);
		Drawable a4 = getContext().getResources().getDrawable(R.drawable.longmao04);
		Drawable a5 = getContext().getResources().getDrawable(R.drawable.longmao05);
		Drawable a6 = getContext().getResources().getDrawable(R.drawable.longmao06);
		Drawable a7 = getContext().getResources().getDrawable(R.drawable.longmao07);
		Drawable a8 = getContext().getResources().getDrawable(R.drawable.longmao08);
