...
import com.cuiweiyou.knockofflongyuan.activity.HomeActivity;
 ...
 */
public class ViewTopScrollerLinearLyt extends LinearLayout {
	...
	/** 2参的构造方法用于在xml里定义 */
	public ViewTopScrollerLinearLyt(Context context, AttributeSet attrs) {
		super(context, attrs);
		/** 屏幕属性对象 **/
...
//--- 手指拿起，up --------------------------------------------------------------
	...
	public void setAty(HomeActivity homeActivity) {
